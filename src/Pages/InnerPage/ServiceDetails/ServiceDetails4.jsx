          ...
          <div className='grid grid-cols-3 gap-[50px] lg:gap-8 xl:gap-[50px]'>
            <div className='col-span-3 lg:col-span-2'>
              ...
              <p
                ...
                data-aos-duration='1000'
              >
                Empower our team to achieve their full
                 potential while providing innovative and 
                 accessible services to our clients.
              ...
              >
                Our focus is on providing high-quality, patient-centered care.
                 We continuously strive to improve our services by utilizing the
                 latest medical advancements and technologies. Our team works collaboratively
              ...
              <p className='font-AlbertSans text-TextColor2-0 mt-6 mb-11'>
                Our focus is on providing high-quality, patient-centered care.
                 We continuously strive to improve our services by utilizing 
                 the latest medical advancements and technologies. Our team works 
                 collaboratively to ensure the best possible outcomes for our patients.
              </p>
              <Faq />
            </div>
